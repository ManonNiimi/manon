...
public class login_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Hi there! Let's log in and get started!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (role != null) {
            if (role.equals("Admin")) {
               ...
               this.dispose();
               FinanceManagerMenu finmenu = new FinanceManagerMenu();
               finmenu.setVisible(true);
            }
        } else {
    ...
    private String validateCredentials(String userName, String password) {
        String filePath = "UserRef.txt"; // Path to your UserRef.txt file
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] col = line.split(","); // Assuming data is comma-separated
                if (col.length >= 5) { // Ensure the row has at least 5 columns
                    String fileUserName = col[2].trim();
                    String filePassword = col[4].trim();
                    if (userName.equals(fileUserName) && password.equals(filePassword)) {
                        return col[1].trim(); // Return the role if credentials match
                    }
                }
            }
        } catch (IOException e) {
