...
public class PM_SalesEntry {
    ...
    public PM_SalesEntry(String salesID,String itemID,int price,int quantitysold,int totalprice,String salesdate, String salesManagerID){
